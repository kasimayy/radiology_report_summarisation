...
experiment = HierCNN2SeqAtt(epochs=epochs,
...
# train
experiment.run_experiment(one_hot_reports_train, one_hot_mesh_shifted_train, one_hot_mesh_train, 
                              one_hot_reports_val, one_hot_mesh_shifted_val, one_hot_mesh_val)
                              
experiment.save_weights_history(model_output_dir)

# evaluate
print(experiment.get_params())
